...
name: Catalog Rule
menu: Mobelaris
route: mobelaris/promotion/catalog-rule
---

# Catalog rule

there is an issue which it used parent promotion status to apply to child-product status for configuration products
