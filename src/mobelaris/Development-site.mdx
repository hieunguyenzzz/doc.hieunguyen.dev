...
update core_config_data set value = 'https://www.mobelaris.com/' where `path` = 'web/unsecure/base_url';
update core_config_data set value = 'https://www.mobelaris.com/' where `path` = 'web/secure/base_url';
